    ...
    return (
        <div className="expert-card">
            <div className="expert-header">
                ...
                <img
                    src={expert.avatar.startsWith('http') ? expert.avatar : images[expert.avatar] || images.mike}
                    alt={expert.name}
            ...
            <div className="expert-footer">
                ...
                <div className="button-container">
                    <button className="contact-button" onClick={() => window.open(expert.contact, '_blank')}>
                        Contact Expert
